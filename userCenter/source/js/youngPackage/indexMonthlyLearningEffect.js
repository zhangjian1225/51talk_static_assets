define("youngPackage/indexMonthlyLearningEffect", ["tpl/youngPackage/index.js", "tplCommon", "../common/courseInfo", "../common/banner","../common/timeout", "../common/packageTab", '../common/detailInfo', '../common/util', '../common/backTop'], function(require, exports, module) {

    //引入套餐模块
    var indexMonthlyLearningEffect = require("tpl/youngPackage/index.js");
    var util = require("../common/util");
    $('#indexMonthlyLearningEffect').html(indexMonthlyLearningEffect.index_monthly_learning_effect());
