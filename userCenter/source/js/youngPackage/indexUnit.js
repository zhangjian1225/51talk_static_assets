define("youngPackage/indexUnit", ["tpl/youngPackage/index.js", "tplCommon", "../common/courseInfo", "../common/banner","../common/timeout", "../common/packageTab", '../common/detailInfo', '../common/util', '../common/backTop'], function(require, exports, module) {

    //引入套餐模块
    var indexUnit = require("tpl/youngPackage/index.js");
    var util = require("../common/util");
    $('#indexUnit').html(indexUnit.index_unit_main());

    var tplCommon = require("tplCommon");
    $("#cartBox").html(tplCommon.cartBox());

    util.renderHeaderBottom();
    util.replaceImgUrl('#indexUnit', static_url);
    //套餐信息
