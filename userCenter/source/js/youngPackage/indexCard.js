define("youngPackage/indexCard", ["tpl/youngPackage/index.js", "tplCommon", "../common/courseInfo", "../common/banner","../common/timeout", "../common/packageTab", '../common/detailInfo', '../common/util', '../common/backTop'], function(require, exports, module) {

    //引入套餐模块
    var indexCard = require("tpl/youngPackage/index.js");
    var util = require("../common/util");
    $('#indexCard').html(indexCard.index_card_main());
